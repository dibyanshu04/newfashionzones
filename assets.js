...
!(function (s) {
    ...
    var e = {
      ...
      i = function (n, t) {
        return n
          ...
          .addClass(t.hoverClass + " " + e.bcClass)
          .filter(function () {
      ...
      h = function (e, o) {
        var i = "li:has(ul)";
        s.fn.hoverIntent && !o.disableHI
          ? e.hoverIntent(u, f, i)
          : e.on("mouseenter.superfish", i, u).on("mouseleave.superfish", i, f);
        var r = "MSPointerDown.superfish";
        n || (r += " touchend.superfish"),
          t && (r += " mousedown.superfish"),
          e
      ...
      f = function () {
        ...
        n
          ...
          : (clearTimeout(t.sfTimer),
            (t.sfTimer = setTimeout(s.proxy(c, e, t), t.delay)));
      },
      c = function (e) {
        (e.retainPath = s.inArray(this[0], e.$path) > -1),
          this.superfish("hide"),
          this.parents("." + e.hoverClass).length ||
            (e.onIdle.call(p(this)), e.$path.length && s.proxy(u, e.$path)());
      },
      p = function (s) {
    ...
    return {
      ...
      show: function () {
        ...
        return (
          ...
          n.stop(!0, !0).animate(s.animation, s.speed, function () {
            s.onShow.call(n);
          }),
          this
        );
        ...
        return this.each(function () {
          ...
          return t
            ? (clearTimeout(t.sfTimer),
              ...
              i.children("ul").attr("style", function (s, e) {
                return e.replace(/display[^;]+;?/g, "");
              }),
              t.$path
                .removeClass(t.hoverClass + " " + e.bcClass)
      ...
      init: function (n) {
        return this.each(function () {
          ...
          (l.$path = i(t, l)),
            ...
            a(t),
            h(t, l),
            u.not("." + e.bcClass).superfish("hide", !0),
            l.onInit.call(this);
        });
      },
    };
  ...
  (s.fn.superfish = function (n) {
    return e[n]
      ...
      : "object" != typeof n && n
      ? s.error("Method " + n + " does not exist on jQuery.fn.superfish")
    ...
    s.fn.extend({ hideSuperfishUl: e.hide, showSuperfishUl: e.show });
})(jQuery);
    ...
    return this.each(function () {
      e(this)
        ...
        .each(function () {
          var c = e(this);
          c.click(function (e) {
            if (c.hasClass("sf-clicked")) {
              var i = c.attr("href");
              window.location = i;
            } else e.preventDefault(), c.addClass("sf-clicked");
          })
            .closest("li")
            .mouseleave(function () {
              c.removeClass("sf-clicked");
            });
        });
    });
  };
...
// jQuery Form NewFashionZones v1.5.2 | (c) Dimox | https://github.com/Dimox/jQueryFormNewFashionZones
(function (c) {
  c.fn.NewFashionZones = function (d) {
    d = c.extend(
      {
        wrapper: "form",
        idSuffix: "-NewFashionZones",
        filePlaceholder:
          "\u0424\u0430\u0439\u043b \u043d\u0435 \u0432\u044b\u0431\u0440\u0430\u043d",
        fileBrowse: "\u041e\u0431\u0437\u043e\u0440...",
        selectSearch: !0,
    ...
    return this.each(function () {
      function w() {
        ...
        void 0 !== a.attr("id") &&
          "" != a.attr("id") &&
          (c = ' id="' + a.attr("id") + d.idSuffix + '"');
        void 0 !== a.attr("title") &&
          "" != a.attr("title") &&
          (m = ' title="' + a.attr("title") + '"');
        void 0 !== a.attr("class") &&
          "" != a.attr("class") &&
          (b = " " + a.attr("class"));
        var t = a.data(),
          h;
        for (h in t) "" != t[h] && (u += " data-" + h + '="' + t[h] + '"');
        this.id = c + u;
        this.title = m;
        this.classes = b;
      }
            ...
            if (1 > a.parent("div.jq-checkbox").length) {
              var d = function () {
                ...
                b.click(function () {
                  b.is(".disabled") ||
                    (a.is(":checked")
                      ? (a.prop("checked", !1), b.removeClass("checked"))
                      : (a.prop("checked", !0), b.addClass("checked")),
                    a.change());
                  return !1;
                });
                a.closest("label")
            ...
            .each(function () {
              if (1 > a.parent("div.jq-file").length) {
                var g = function () {
                  ...
                  c(
                    '<div class="jq-file__browse">' + d.fileBrowse + "</div>"
                  ).appendTo(b);
                  a.after(b);
                  b.append(a);
                  a.is(":disabled") && b.addClass("disabled");
                  a.change(function () {
                    var c = a.val();
                    if (a.is("[multiple]"))
                      for (var c = "", h = a[0].files, m = 0; m < h.length; m++)
                        c += (0 < m ? ", " : "") + h[m].name;
                    g.text(c.replace(/.+[\\\/]/, ""));
                    "" == c
                      ? (g.text(d.filePlaceholder), b.removeClass("changed"))
                      : b.addClass("changed");
                  })
                    .focus(function () {
                      b.addClass("focused");
            ...
            if (1 > a.parent("div.jqselect").length) {
              var g = function () {
                    ...
                    function (a) {
                      ...
                      "mousewheel" == a.type
                        ...
                        : "DOMMouseScroll" == a.type &&
                          (b = 40 * a.originalEvent.detail);
                      b &&
                        (a.stopPropagation(),
                        a.preventDefault(),
                        c(this).scrollTop(b + c(this).scrollTop()));
                    }
                  );
                }
                function b() {
                  ...
                  for (len = h.length; i < len; i++) {
                    ...
                    h.eq(i).is(":disabled") && (c = "disabled");
                    h.eq(i).is(":selected:disabled") &&
                      (c = "selected sel disabled");
                    void 0 !== h.eq(i).attr("class") &&
                      ((b = " " + h.eq(i).attr("class")),
                      (m = ' data-jqfs-class="' + h.eq(i).attr("class") + '"'));
                    var f = h.eq(i).data(),
                      n;
                    for (n in f)
                      "" != f[n] && (a += " data-" + n + '="' + f[n] + '"');
                    a =
                      ...
                      h.eq(i).text() +
                      "</li>";
                    h.eq(i).parent().is("optgroup") &&
                      (void 0 !== h.eq(i).parent().attr("class") &&
                        (d = " " + h.eq(i).parent().attr("class")),
                      (a =
                        "<li" +
                        m +
                        ' class="' +
                        ...
                        h.eq(i).text() +
                        "</li>"),
                      h.eq(i).is(":first-child") &&
                        (a =
                          '<li class="optgroup' +
                          d +
                          '">' +
                          h.eq(i).parent().attr("label") +
                          "</li>" +
                          a));
                    x += a;
                  }
                ...
                function g() {
                  ...
                  a.css({ margin: 0, padding: 0 }).after(e).prependTo(e);
                  var s = c("div.jq-selectbox__select", e),
                    q = c("div.jq-selectbox__select-text", e),
                    k = h.filter(":selected");
                  k.length ? q.html(k.text()) : q.html(h.first().text());
                  b();
                  var p = "";
                  /*d.selectSearch&&(p='<div class="jq-selectbox__search"><input type="search" autocomplete="off" placeholder="'+d.selectSearchPlaceholder+'"></div><div class="jq-selectbox__not-found">'+d.selectSearchNotFound+"</div>");*/ var f = c(
                  ...
                  var n = c("ul", f),
                    l = c("li", f),
                    r = c("input", f),
                    y = c("div.jq-selectbox__not-found", f).hide();
                  l.length < d.selectSearchLimit && r.parent().hide();
                  var v = 0,
                    B = 0;
                  l.each(function () {
                    var a = c(this);
                    ...
                    a.innerWidth() > v &&
                      ((v = a.innerWidth()), (B = a.width()));
                    a.css({ display: "block" });
                  });
                  var p = e.clone().appendTo("body").width("auto"),
                    t = p.width();
                  p.remove();
                  t == e.width() &&
                    (q.width(B),
                    (v += e.find("div.jq-selectbox__trigger").width()));
                  v > e.width() && f.width(v);
                  a.css({
                    position: "absolute",
                    left: 0,
                  ...
                  var u = e.outerHeight(),
                    ...
                    z = n.css("max-height"),
                    p = l.filter(".selected");
                  1 > p.length && l.first().addClass("selected sel");
                  void 0 === l.data("li-height") &&
                    l.data("li-height", l.outerHeight());
                  var C = f.css("top");
                  "auto" == f.css("left") && f.css({ left: 0 });
                  "auto" == f.css("top") && f.css({ top: u });
                  f.hide();
                  p.length &&
                    (h.first().text() != k.text() && e.addClass("changed"),
                    e.data("jqfs-class", p.data("jqfs-class")),
                    e.addClass(p.data("jqfs-class")));
                  if (a.is(":disabled")) return e.addClass("disabled"), !1;
                  s.click(function () {
                    a.focus();
                    c("div.jq-selectbox").filter(".opened").length &&
                      d.onSelectClosed.call(
                        c("div.jq-selectbox").filter(".opened")
                      );
                    if (!navigator.userAgent.match(/(iPad|iPhone|iPod)/g)) {
                      if (d.selectSmartPositioning) {
                        var b = c(window),
                          h = e.offset().top,
                          q = b.height() - u - (h - b.scrollTop()),
                          k = d.selectVisibleOptions,
                          g = l.data("li-height"),
                          s = 5 * g,
                          p = g * k;
                        0 < k && 6 > k && (s = p);
                        0 == k && (p = "auto");
                        q > s + A + 20
                          ? (f.height("auto").css({ bottom: "auto", top: C }),
                            (k = function () {
                              n.css(
                                "max-height",
                                Math.floor((q - 20 - A) / g) * g
                              );
                            }),
                            k(),
                            n.css("max-height", p),
                            "none" != z && n.css("max-height", z),
                            q < f.outerHeight() + 20 && k())
                          : (f.height("auto").css({ top: "auto", bottom: C }),
                            (k = function () {
                              n.css(
                                "max-height",
                                Math.floor((h - b.scrollTop() - 20 - A) / g) * g
                              );
                            }),
                            k(),
                            n.css("max-height", p),
                            "none" != z && n.css("max-height", z),
                            h - b.scrollTop() - 20 < f.outerHeight() + 20 &&
                              k());
                      }
                      c("div.jqselect")
                        .css({ zIndex: d.singleSelectzIndex - 1 })
                        .removeClass("opened");
                      e.css({ zIndex: d.singleSelectzIndex });
                      f.is(":hidden")
                        ? (c("div.jq-selectbox__dropdown:visible").hide(),
                          f.show(),
                          e.addClass("opened focused"),
                          d.onSelectOpened.call(e))
                        : (f.hide(),
                          e.removeClass("opened"),
                          c("div.jq-selectbox").filter(".opened").length &&
                            d.onSelectClosed.call(e));
                      l.filter(".selected").length &&
                        (0 != (n.innerHeight() / g) % 2 && (g /= 2),
                        n.scrollTop(
                          n.scrollTop() +
                      ...
                      r.length &&
                        ...
                        r.focus().keyup(function () {
                          ...
                          1 > l.filter(":visible").length ? y.show() : y.hide();
                        }));
                      m(n);
                      return !1;
                    }
                  ...
                  l.filter(":not(.disabled):not(.optgroup)").click(function () {
                    ...
                    if (D != n) {
                      var l = b.index(),
                        l = l - b.prevAll(".optgroup").length;
                      b.addClass("selected sel")
                        .siblings()
                        .removeClass("selected sel");
                      h.prop("selected", !1).eq(l).prop("selected", !0);
                      D = n;
                      q.html(n);
                      e.data("jqfs-class") &&
                        e.removeClass(e.data("jqfs-class"));
                  ...
                  a.change(function () {
                    q.html(h.filter(":selected").text());
                    l.removeClass("selected sel")
                      .not(".optgroup")
                      .eq(a[0].selectedIndex)
                      .addClass("selected sel");
                    h.first().text() != l.filter(".selected").text()
                      ? e.addClass("changed")
                    ...
                    .on("keydown keyup", function (c) {
                      q.html(h.filter(":selected").text());
                      l.removeClass("selected sel")
                        .not(".optgroup")
                        .eq(a[0].selectedIndex)
                        .addClass("selected sel");
                      (38 != c.which && 37 != c.which && 33 != c.which) ||
                        f.scrollTop(
                          f.scrollTop() + l.filter(".selected").position().top
                        );
                      (40 != c.which && 39 != c.which && 34 != c.which) ||
                        f.scrollTop(
                          f.scrollTop() +
                            l.filter(".selected").position().top -
                            f.innerHeight() +
                      ...
                      13 == c.which && (c.preventDefault(), f.hide());
                    });
                  c(document).on("click", function (a) {
                    c(a.target).parents().hasClass("jq-selectbox") ||
                      ...
                      r.length && r.val("").keyup(),
                      f.hide().find("li.sel").addClass("selected"),
                      e.removeClass("focused opened"));
                  });
                }
                function t() {
                  var d = new w(),
                  ...
                  a.css({ margin: 0, padding: 0 }).after(e);
                  b();
                  e.append("<ul>" + x + "</ul>");
                  var g = c("ul", e).css({
                      position: "relative",
                  ...
                  void 0 !== d && 0 < d
                    ...
                    : g.css({ height: 4 * f });
                  p > e.height() &&
                    (g.css("overflowY", "scroll"),
                    m(g),
                    k.filter(".selected").length &&
                      g.scrollTop(
                        g.scrollTop() + k.filter(".selected").position().top
                      ));
                  a.prependTo(e).css({
                    position: "absolute",
                    left: 0,
                  ...
                  a.is(":disabled")
                    ? (e.addClass("disabled"),
                      h.each(function () {
                        c(this).is(":selected") &&
                          k.eq(c(this).index()).addClass("selected");
                      }))
                    : (k
                      ...
                      p > e.height() &&
                        a.keydown(function (a) {
                          (38 != a.which && 37 != a.which && 33 != a.which) ||
                            g.scrollTop(
                              g.scrollTop() +
                                k.filter(".selected").position().top -
                                f
                            );
                          (40 != a.which && 39 != a.which && 34 != a.which) ||
                            g.scrollTop(
                              g.scrollTop() +
                                k.filter(".selected:last").position().top -
                                g.innerHeight() +
                                2 * f
                            );
                        }));
...
// tm-stick-up.js ******************************************************************************************************************
!(function (o) {
  o.fn.tmStickUp = function (t) {
    function e() {
      (a = parseInt(n.offset().top)),
        (d = parseInt(n.css("margin-top"))),
        (u = parseInt(n.outerHeight(!0))),
        o('<div class="pseudoStickyBlock"></div>').insertAfter(n),
        (s = o(".pseudoStickyBlock")),
        s.css({ position: "relative", display: "block" }),
        c();
    }
    function c() {
      p.on("scroll", function () {
        (r = o(this).scrollTop()),
          (g = r > h ? "down" : "up"),
          (h = r),
          (correctionValue = i.correctionSelector.outerHeight(!0)),
          ...
          a - correctionValue < f
            ...
            : (n.removeClass("isStuck"),
              ...
              s.css({ height: 0 })),
          o(".cart_popup").css("top", s.innerHeight());
      }).trigger("scroll");
    }
    var i = { correctionSelector: o(".correctionSelector") };
    o.extend(i, t);
    var s,
      r,
      n = o(this),
